<body Class='SC'>
	...
	<TR>
		...
		<TD><A HREF="DelTravel0.jsp" target="AdminBodyFrame"><img border="0" name="DelTravel" src="Images/Menu/DelTravel0.jpg" width="100" height="20" onmouseover="document['DelTravel'].src='Images/Menu/DelTravel1.jpg'" onmouseout="document['DelTravel'].src='Images/Menu/DelTravel0.jpg'" ></A></TD>

	<TD>&nbsp;&nbsp;<a href="Home.jsp" target="_top">Logout</a></TD>	</TR>
	</TR>
	</TABLE>
</BODY>